...
const WebLeftText = ({ className = "" }) => {
  const navigate = useNavigate();

  const onCommonButtonContainerClick = useCallback(() => {
    navigate("/sign-up1");
  }, [navigate]);
    ...
    <div className={[styles.webLeftText, className].join(" ")}>
      <div className={styles.mainHeader}>
        <h1 className={styles.meditrack}>
          <span className={styles.meditrackTxt}>
      ...
      <div
        ...
        onClick={onCommonButtonContainerClick}
      >
